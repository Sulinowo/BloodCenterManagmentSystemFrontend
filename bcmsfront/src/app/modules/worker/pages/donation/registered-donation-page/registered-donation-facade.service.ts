...
export class RegisteredDonationFacadeService {
  ...
  public isExaminationNullable$ = this.profileFacade.donationDetails$.pipe(map((x: DonationDetails) => x.resultOfExamination === null));
  public isExaminationNullable2$ = this.profileFacade.donationDetails$.pipe(map((x: DonationDetails) => x.resultOfExamination.height === null));
